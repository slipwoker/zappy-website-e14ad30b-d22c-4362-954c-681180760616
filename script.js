...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    const validators = {
      text: function(value) {
        return value.trim().length >= 2 ? '' : 'This field must be at least 2 characters';
      },
      ...
      tel: function(value) {
        ...
        return value.trim() === '' || telRegex.test(value.trim()) ? '' : 'Please enter a valid phone number';
      },
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e14ad30b-d22c-4362-954c-681180760616',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e14ad30b-d22c-4362-954c-681180760616';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e14ad30b-d22c-4362-954c-681180760616';
